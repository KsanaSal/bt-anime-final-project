...
const ActionButton = ({
    ...
    const baseStyles =
        "px-4 py-2 rounded font-medium transition transition-transform duration-150 ease-in-out cursor-pointer hover:shadow-lg hover:shadow-gray-700 text-xs md:text-base lg:text-lg";
